    ...
    <div className="bg-gray-100 min-h-screen font-sans">
      ...
      <main className="w-full max-w-7xl mx-auto px-6 py-12">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {/* Action Cards */}
            <div className="flex flex-col items-center justify-center text-center p-6 bg-green-50 rounded-2xl border-2 border-dashed border-green-300 text-green-700 hover:bg-green-100 hover:border-green-400 transition cursor-pointer">
                <Plus size={32} />
