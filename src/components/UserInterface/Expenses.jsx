...
import 'react-day-picker/dist/style.css'; // Don't forget to import calendar styles
    ...
    <div className="bg-gray-100 min-h-screen font-sans">
      ...
      <main className="w-full max-w-5xl mx-auto px-4 py-12">
        <header className="flex flex-col md:flex-row items-center justify-between gap-6 mb-8">
            <button className="w-full md:w-auto flex items-center justify-center gap-2 px-6 py-4 bg-green-600 text-white font-bold rounded-xl hover:bg-green-500 transition-transform transform hover:scale-105 shadow-lg order-1 md:order-none">
                <Plus size={24} />
